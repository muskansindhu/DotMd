...
`
  ...
  {
    slug: "who-uses-size-limit",
    name: "👥 Who Uses Size Limit",
    markdown: `
...
`
  ...
  {
    slug: "js-application-and-time-based-limit",
    name: "📄 JS Application and Time-based Limit",
    markdown: `
...
`
  ...
  {
    slug: "small-libraries",
    name: "📄 Small Libraries",
    markdown: `
JS libraries < 10 kB in size.
...
`
  ...
  {
    slug: "analyze-with---why",
    name: "🔍 Analyze with `--why`",
    markdown: `
